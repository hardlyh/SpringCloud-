<template>
  <div>
    <el-form :inline="true" :model="formInline" class="demo-form-inline">
      ...
      <el-form-item>
        <el-button type="primary" @click="inquir">查询</el-button>
      </el-form-item>
    </el-form>

    <el-table :data="countInfo" border style="width: 100%">
      <el-table-column prop="price" :formatter="amountFormat" label="总支出额(本金)" align="center"></el-table-column>
    ...
    <el-dialog title="支出明细" :visible.sync="dialogTableVisible">
      ...
      <el-table :data="detailList">
        ...
        <el-table-column prop="price" :formatter="amountFormat" label="支出" align="center"></el-table-column>
        <el-table-column prop="profit" :formatter="amountFormat" label="总利润" align="center"></el-table-column>
        <el-table-column prop="totalAmt" :formatter="amountFormat" label="总金额" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    cliRow(rows) {
      this.dialogTag = {};
      this.detailList = [];
      let dateTime = rows.outlayDay;
      this.dialogTag.pay = rows.price / 100;
      this.dialogTag.profit = rows.profit / 100;
      let data = {
        dateTime: dateTime,
      };
      this.apis.getPayInfoDetail(data).then((response) => {
    ...
    inquir() {
      this.countInfo = [];
      this.groupList = [];
      this.apis.getPayInfo(this.formInline).then((response) => {
